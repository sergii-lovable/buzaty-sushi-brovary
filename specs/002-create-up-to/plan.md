...
- **index.html** (line 171-175): Clean noscript section with only placeholder comment `<!-- NOSCRIPT_MENU_PLACEHOLDER -->` - all static content removed, plugin populates during build
